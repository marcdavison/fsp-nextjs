...
const RealtimeFixtureGroup = ({ date, games, allowPredictions, userPredictions, isResultsPage }: { date: string;  games: {  [key: string]: FixtureData}; allowPredictions: boolean; userPredictions: undefined | UserPredictions; isResultsPage: boolean}) => {
  // declare calculator
  console.log('RealtimeFixtureGroup.....');
  console.log(games);
...
export default RealtimeFixtureGroup;