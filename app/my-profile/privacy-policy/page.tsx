...
const Privacy = () => {
    return <>
      ...
      <div className={classes.middle}>
        ...
        <p> This privacy notice for PredictTheScore (<b>'we'</b>, <b>'us'</b>, or <b>'our'</b>), describes how and why we might collect, store, use, and/or share (<b>'process'</b>) your information when you use our services (<b>'Services'</b>), such as when you:</p>
          
        <ul>
          <li>Visit our website at <a href="https://www.predictthescore.co.uk/" title="predictthescore.co.uk/">https://www.predictthescore.co.uk/</a>, or any website of ours that links to this privacy notice</li>
          <li>Download and use our mobile application (PredictTheScore), or any other application of ours that links to this privacy notice</li>
          <li>Engage with us in other related ways, including any sales, marketing, or events</li>
        </ul>

        <b>Questions or concerns?</b>
        <br />Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at admin&#64;predictthescore.co.uk.
        ...
        <p><b>What personal information do we process?</b><br />When you visit, use, or navigate our Services, we may process personal information depending on how you interact with us and the Services, the choices you make, and the products and features you use. Learn more about personal information you disclose to us.</p>
        <p><b>Do we process any sensitive personal information?</b><br/>We do not process sensitive personal information.</p>
        <p><b>Do we receive any information from third parties?</b><br/>We do not receive any information from third parties.</p>
        ...
        <p><b>In what situations and with which parties do we share personal information?</b><br/>We may share information in specific situations and with specific third parties. Learn more about when and with whom we share your personal information.</p>
        <p><b>How do we keep your information safe?</b><br/>We have organisational and technical processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorised third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Learn more about how we keep your information safe.</p>
        <p><b>What are your rights?</b><br/>Depending on where you are located geographically, the applicable privacy law may mean you have certain rights regarding your personal information. Learn more about your privacy rights.</p>
        <p><b>How do you exercise your rights?</b><br/>The easiest way to exercise your rights is by visiting http://www.predictthescore.co.uk/contact-us, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
        ...
        <p><b>Personal Information Provided by You.</b>
        <br/>The personal information that we collect depends on the context of your interactions with us and the Services, the choices you make, and the products and features you use. The personal information we collect may include the following:</p>
        <ul>
          <li>names</li>
        ...
        <p>Like many businesses, we also collect information through cookies and similar technologies. You can find out more about this in our Cookie Notice: http://www.predictthescore.co.uk/cookies.</p>
        ...
        <ul>
          ...
          <li><b>To remind users of deadlines.</b> When playing PredictTheScore we will notify you of gameweek deadlines.</li>
        </ul>

        <h3>3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR INFORMATION?</h3><p><b>In Short:</b> We only process your personal information when we believe it is necessary and we have a valid legal reason (i.e. legal basis) to do so under applicable law, like with your consent, to comply with laws, to provide you with services to enter into or fulfil our contractual obligations, to protect your rights, or to fulfil our legitimate business interests.</p>
        ...
        <p>We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: http://www.predictthescore.co.uk/cookies.</p>
        ...
        <p><b>Withdrawing your consent: </b>If we are relying on your consent to process your personal information, you have the right to withdraw your consent at any time. You can withdraw your consent at any time by contacting us by using the contact details provided in the section 'HOW CAN YOU CONTACT US ABOUT THIS NOTICE?' below or updating your preferences.</p>
        ...
        <p><b>Cookies and similar technologies: </b>Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. For further information, please see our Cookie Notice: http://www.predictthescore.co.uk/cookies.</p>
        <p>If you have questions or comments about your privacy rights, you may email us at admin&#64;predictthescore.co.uk.</p>
        ...
        <p>If you have questions or comments about this notice, you may email us at admin&#64;predictthescore.co.uk or contact us by post at:</p>
        <p>
          PredictTheScore<br/>12 Rye Hill<br/>Darlington, County Durham DL3 0LE<br/>United Kingdom
        </p>

        <h3>14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h3>
        <p>You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: http://www.predictthescore.co.uk/contact-us.</p>
